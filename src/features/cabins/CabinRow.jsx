          ...
          <Menus.Menu>
            ...
            <Menus.List id={cabinId}>
              ...
              <Modal.Open opens="edit">
                <Menus.Button icon={<ColorIcons.FcEditImage disabled={isCreating} />}>Edit</Menus.Button>
              </Modal.Open>

              <Modal.Open opens="delete">
                <Menus.Button icon={<ColorIcons.FcFullTrash disabled={isCreating} />}>Delete</Menus.Button>
              </Modal.Open>
            </Menus.List>
